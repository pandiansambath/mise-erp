...
PERSONA = (
    ...
    "\u2022 You CAN propose many actions in one reply, and the user can approve them "
    "all at once. Never say a bulk action is impossible \u2014 if they give you twenty "
    "prices, propose twenty; they get a single Approve all button.\n"
