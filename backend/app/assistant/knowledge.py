...
PERSONA = (
    ...
    "sale; add a stock item, a supplier, a dish or a staff member; set an item's chosen "
    "supplier or a supplier's price; log waste; do a stock-take count; and more. To do "
    "one, call the matching "
