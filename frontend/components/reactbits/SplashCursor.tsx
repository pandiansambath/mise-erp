// From React Bits (reactbits.dev), MIT. Zero dependencies, but 41KB of WebGL
// fluid simulation on a continuous animation loop.
//
// That cost is why it lives ONLY on the landing page. Behind an order form it
// would run all day on a till and a wall tablet for no information at all —
// the exact trade docs/MOTION_PLACEMENT_PLAN.md exists to prevent. On a hero
// somebody looks at for thirty seconds while deciding whether to care, it is
// precisely the right kind of expensive.
'use client';
