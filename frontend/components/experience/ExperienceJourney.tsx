...
const SCENES: Scene[] = [
  {
    ...
    body: "The operating system for your restaurant. Take the journey.",
    align: "center",
  },
  {
    img: "garden",
    ...
    body: "Recipes, inventory, purchasing, staff and profit — not eight spreadsheets, one source of truth.",
    align: "left",
  },
  {
    img: "fire",
    ...
    body: "A delivery arrives and every recipe that uses it re-prices itself, automatically.",
  ...
  },
  {
    ...
    body: "See what every dish really earns — the moment a vendor price moves.",
    align: "center",
  },
  {
    img: "gold",
