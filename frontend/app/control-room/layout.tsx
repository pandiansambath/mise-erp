...
// Standalone shell for the 🛰️ Control Room — the DineAI OPERATOR area, deliberately
// SEPARATE from any hotel's app (no hotel sidebar). An operator logs in with the
// platform credential and lands straight here to manage every hotel on DineAI.
