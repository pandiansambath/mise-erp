    ...
    <div className="space-y-4">
      <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
        <div>
          ...
          <p className="text-lg font-semibold text-slate-900">£{data.cost_per_serving}</p>
        </div>
        <div>
        ...
        <div>
          ...
          <p className="text-lg font-semibold text-slate-900">£{data.total_cost}</p>
        </div>
      </div>
          ...
          <tbody>
            {data.ingredients.map((ing) => (
              <tr key={ing.item_id} className="border-b border-slate-100">
                ...
                <td className="py-2 pr-4 text-right text-slate-600">£{ing.unit_price}</td>
